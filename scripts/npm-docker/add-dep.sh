...
docker image rm <dockerhub-org-name>/<image-name> --force
echo -e "\033[1;36mRebuilding image with updated package.json...\033[0m"
docker build -t <dockerhub-org-name>/<image-name> -f Dockerfile-dev .
echo -e "\033[1;32mDone!\033[0m"
echo -e "\033[1;33mREMINDER: 'docker push <dockerhub-org-name>/<image-name>' once you're satisfied with the new dependencies. This will push your image to DockerCloud for everyone else to use.\033[0m"
